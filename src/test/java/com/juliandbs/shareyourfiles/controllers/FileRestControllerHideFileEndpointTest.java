...
@DisplayName("FileRestController HideFile Endpoint Test")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@ActiveProfiles("test")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
public class FileRestControllerHideFileEndpointTest {
    ...
    private static final String hideFilePath = "/file/hide-file";
    ...
    @Test
    @Order(1)
    @DisplayName("'/file/hide-file' does not throw exception and status 200 | ")
    public void hideFileResourceDoesNotThrowExceptionAndAssertStatus200Test() throws IOException {
        //given
        ...
        JsonResponse jsonResponse = objectMapper.readValue(body, JsonResponse.class);
        assertEquals(200, jsonResponse.getStatus());
        assertEquals("The File is now private", jsonResponse.getMessage());
    }

    @Test
    @Order(2)
    @DisplayName("'/file/hide-file' status 400 | File not exists")
    public void hideFileStatus400FileNotExistsTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(3)
    @DisplayName("'/file/hide-file' status 400 | File password is to short")
    public void hideFileStatus400FilePasswordIsToShortTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(4)
    @DisplayName("'/file/hide-file' status 400 | File password is to long")
    public void hideFileStatus400FilePasswordIsToLongTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(5)
    @DisplayName("'/file/hide-file' status 400 | Invalid file password")
    public void hideFileStatus400InvalidFilePasswordTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(6)
    @DisplayName("'/file/hide-file' status 400 | Forbidden file access")
    public void hideFileStatus400ForbiddenFileAccessTest() throws JsonProcessingException {
        //given
