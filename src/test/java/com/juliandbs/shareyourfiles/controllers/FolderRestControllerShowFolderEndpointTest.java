...
@DisplayName("FolderRestController ShowFolder Endpoint Test")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@ActiveProfiles("test")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureWebTestClient
public class FolderRestControllerShowFolderEndpointTest {
    ...
    private static final String showFolderPath = "/folder/show-folder";
    ...
    @Test
    @Order(1)
    @DisplayName("'/folder/show-folder' does not throw exception and status is 200 | Folder is now public")
    public void showFolderDoesNotThrowExceptionAndAssertStatus200Test() {
        //given
        ...
        assertDoesNotThrow( () -> {
            ...
            JsonResponse jsonResponse = objectMapper.readValue(body, JsonResponse.class);
            assertEquals(200, jsonResponse.getStatus());
            assertEquals("Folder is now public", jsonResponse.getMessage());
        });
    }

    @Test
    @Order(2)
    @DisplayName("'/folder/show-folder' status 400 | Folder does not exists")
    public void showFolderStatus400FolderDoesNotExistsTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(3)
    @DisplayName("'/folder/show-folder' status 400 | Folder password is to short")
    public void showFolderStatus400FolderPasswordIsToShortTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(4)
    @DisplayName("'/folder/show-folder' status 400 | Folder password is to long")
    public void showFolderStatus400FolderPasswordIsToLongTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(5)
    @DisplayName("'/folder/show-folder' status 400 | Invalid folder password")
    public void showFolderStatus400InvalidFolderPasswordTest() throws JsonProcessingException {
        //given
    ...
    @Test
    @Order(6)
    @DisplayName("'/folder/show-folder' status 400 | Forbidden folder access" )
    public void showFolderStatus400ForbiddenFolderAccessTest() throws JsonProcessingException {
        //given
