 ...
 * @author JulianDbs
 */
public class InvalidUserPasswordException extends UserRestException {

    public InvalidUserPasswordException() {super("Invalid user password");}
    ...
    public InvalidUserPasswordException(Throwable cause) {super(cause);}
}
