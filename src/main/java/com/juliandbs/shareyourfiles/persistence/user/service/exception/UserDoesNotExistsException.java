 ...
 * @author JulianDbs
 */
public class UserDoesNotExistsException extends UserRestException {

    public UserDoesNotExistsException() {super("User does not exists");}
    ...
    public UserDoesNotExistsException(Throwable cause) {super(cause);}
}
