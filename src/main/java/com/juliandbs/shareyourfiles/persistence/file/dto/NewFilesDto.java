 ...
 */
@PasswordMatches()
public class NewFilesDto implements Serializable {
    ...
    public NewFilesDto(String fromUrl, String folderId) throws NullPointerException {
    ...
    public NewFilesDto(String fromUrl, List<MultipartFile> files, String folderId, Boolean fileIsPrivate, Boolean fileHavePassword, String password, String matchPassword) throws NullPointerException {
        if (fromUrl == null || files == null || folderId == null || fileIsPrivate == null || fileHavePassword == null || password == null || matchPassword ==  null)
            throw new NullPointerException();
        this.fromUrl = fromUrl;
        this.files = files;
        this.folderId = folderId;
    ...
    public Boolean isValid() {
        return (fromUrl != null && files != null && folderId != null && fileIsPrivate != null && fileHavePassword != null && password != null && matchPassword != null);
    }
    ...
    public void setFile(List<MultipartFile> files) throws NullPointerException {
        if (files == null)
            throw new NullPointerException();
        this.files = files;
    }
    ...
    public void setFolderId(String folderId) throws NullPointerException {
        if (folderId == null)
            throw new NullPointerException();
        this.folderId = folderId;
    }
